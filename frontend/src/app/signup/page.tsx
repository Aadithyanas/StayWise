  ...
  return (
    <main className="relative flex min-h-screen items-center justify-center overflow-hidden bg-gradient-to-br from-blue-600 via-blue-700 to-indigo-700 px-4 py-12">
      ...
      <div ref={cardRef} className="auth-card relative z-10 mx-auto w-full max-w-md rounded-2xl bg-white/90 p-6 shadow-xl backdrop-blur">
        <h1 className="auth-title mb-2 text-2xl font-bold text-gray-900">Create account</h1>
        <p className="mb-6 text-sm text-gray-600">Join StayWise to explore and book amazing stays.</p>
        ...
        <form onSubmit={handleSubmit} className="space-y-3">
          ...
          <p className="auth-field text-center text-sm text-gray-600">Already have an account? <a href="/login" className="text-blue-700 hover:underline">Sign in</a></p>
        </form>
      </div>
    </main>
  );
